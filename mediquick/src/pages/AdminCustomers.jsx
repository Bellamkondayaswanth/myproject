                  ...
                  <tr key={c._id} style={{ borderBottom: '1px solid var(--border)' }}
                    ...
                    <td style={{ padding: '14px 16px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                        <div style={{
                          ...
                          fontWeight: 700, fontSize: '16px', fontFamily: 'Fraunces, serif'
                        }}>
                    ...
                    <td style={{ padding: '14px 16px' }}>
                      <span style={{
                        ...
                        background: c.role === 'admin' ? '#1e293b' : '#dcfce7',
                        color: c.role === 'admin' ? 'white' : '#16a34a'
                      }}>{c.role}</span>
                    </td>
                    ...
                    <td style={{ padding: '14px 16px' }}>
                      <button onClick={() => setSelected(selected?._id === c._id ? null : c)} style={{
                        padding: '6px 14px', borderRadius: '8px',
                        border: '1px solid var(--primary)',
                        background: selected?._id === c._id ? 'var(--primary)' : 'white',
                        color: selected?._id === c._id ? 'white' : 'var(--primary)',
                        fontSize: '12px', fontWeight: 600, cursor: 'pointer'
                      }}>{selected?._id === c._id ? 'Close' : 'View'}</button>
                    </td>
                  </tr>
                ))}
              </tbody>
            ...
            <div style={{ background: 'white', borderRadius: '16px', border: '1px solid var(--border)', padding: '24px', height: 'fit-content' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 24 }}>
                <div style={{
                  ...
                  background: 'var(--primary)', color: 'white',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  fontWeight: 700, fontSize: '26px', fontFamily: 'Fraunces, serif'
                }}>
                ...
                <div>
                  ...
                  <span style={{
                    fontSize: '11px', fontWeight: 700, padding: '3px 10px', borderRadius: '20px',
                    background: selected.role === 'admin' ? '#1e293b' : '#dcfce7',
                    color: selected.role === 'admin' ? 'white' : '#16a34a'
                  }}>{selected.role}</span>
                </div>
              </div>
