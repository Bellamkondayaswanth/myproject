  ...
  if (ordered) return (
    <div style={{
      ...
      <Link to="/orders" style={{
        ...
        padding: '12px 32px', borderRadius: '12px', fontWeight: 600
      }}>Track Order</Link>
    </div>
  );
      ...
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        {user && (
          <p style={{ color: 'var(--text-muted)', marginBottom: 24 }}>
            Delivering to: <strong>{user.address || 'Update address in profile'}</strong>
          </p>
        )}
            ...
            {cart.map(item => (
              <div key={item._id} style={{
                ...
                <button onClick={() => removeFromCart(item._id)} style={{
                  ...
                  width: 32, height: 32, borderRadius: '8px', cursor: 'pointer', fontSize: '16px'
                }}>✕</button>
              </div>
            ))}
          </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: 20 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '14px' }}>
                ...
                <span style={{ color: delivery === 0 ? '#16a34a' : 'inherit' }}>
